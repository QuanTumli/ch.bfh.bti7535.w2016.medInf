...
import features.NegationFeature2;
import features.SpecialCharsFeature;
...
//			add(getNegationFeature()); // Little buggy buts gets all kinds of negations.
	...
	/**
	 * Gets the negation feature 2.
	 *
	 * @return the negation feature
	 */
	private NegationFeature2 getNegationFeature2() {
		return new NegationFeature2();
	}
	...
	/**
	 * Gets the special chars feature.
	 *
	 * @return the specials chars feature
	 */
	private Feature getSpecialCharsFeature() {
		return new SpecialCharsFeature();
	}
